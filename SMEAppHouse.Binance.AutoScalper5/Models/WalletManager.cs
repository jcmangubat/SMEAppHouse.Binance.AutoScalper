...
namespace SMEAppHouse.Binance.AutoScalper5.Models
{
    public class WalletManager
    {
        ...
        /// <returns></returns>
        public WalletManager Initialize(BinanceApiKeys apiKeys, string[] cryptoSymbols)
        {
            _apiKeys = apiKeys;
            ...
            //var cryptExcInfTest = Instance.ExchangeInfo.Symbols.FirstOrDefault(p => p.BaseAsset.Equals("ETH") && p.QuoteAsset.Equals("USDT"));

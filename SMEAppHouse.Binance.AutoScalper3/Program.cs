...
using SMEAppHouse.Binance.AutoScalper3.Worker;
...
namespace SMEAppHouse.Binance.AutoScalper3
{
    class Program
    {
        private static TradeBrokerService _traderBrokerService;
        ...
        private static void _traderService_OnMACDPatternIdentified(object sender, TradeBrokerService.MACDPatternGeneratedEventArgs e)
        {
            Console.WriteLine($"\r\n ---> {e.MACDPattern.ToPatternString()}\r");
        }

        private static void _traderBrokerService_OnMACDPatternAnalyzed(object sender, TradeBrokerService.MACDPatternAnalyzedEventArgs e)
        {
            /*if (e.TradeAction != Rules.TradeActionsEnum.NONE)
                Console.WriteLine($"\r MACD pattern analyzed : \r");*/
        }

        private static void _traderService_OnTickCallback(object sender, TradeBrokerService.TickCallbackEventArgs e)
        {
